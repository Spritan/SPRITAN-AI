...
int main()
        ...
        while(input!="exit")
            ...
            if ((!strcmp(tinput,"hi"))||(!strcmp(tinput,"hi."))
                ...
                ||(!strcmp(tinput,"hello"))||(!strcmp(tinput,"hellow")))
              {
                  ...
                  switch(randam)
                    {
                        case 0:cout << "Hello there " << endl ;
                            break;
                        case 1:cout << "What's up, dude. "<<endl;
                            break;
                        case 2:cout << "Yo Amigo. "<<endl;
                    }
                   flag++;
              }
            if ((!strcmp(tinput,"how are you?"))||(!strcmp(tinput,"how are you")))
                {
                    ...
                    switch(randam)
                        {
                            case 0:cout << "I am good, how are you" << endl ;
                                break;
            ...
            if (!strcmp(tinput,"i am fine")||!strcmp(tinput,"i am fine too")
                ||!strcmp(tinput,"fine fine")||!strcmp(tinput,"good"))
                {
                    ...
                    switch(randam)
                        {
                            case 0:cout << "Thats good to know, command me something" << endl ;
                                    break;
    ...
    void tictactoe()
    {
        ...
        if(ch=='n'||ch=='N')
            {
                cin.get();
                cout<<"SPRITAN =>Some day i will learn to play too.\n\tMean while what shall i do next?\n";//add to answer if requested for other games
            }
    }
    int checkwin()
    {
      ...
      if(ch=='Y'||ch=='y')
       ...
       //chances left
        ...
        if(ch=='n'||ch=='N')
            {
                cin.get();
                cout<<"SPRITAN => Hopefully you are satisfied .\n\tMean while what shall i do next?\n";
                return;
            }
        if(ans=='n'||ans=='N')
                {
                    cin.get();
                    cout<<"SPRITAN => What should i do next?\n";
                }
    }
void extra(char Q[])
    {
      ...
      if(!fii)
      {
          cout<<"SPRITAN => Sorry, i am not feeling well i have to get rest..";
          exit(1);
      }
      while(!fii.eof())
    	{
        ...
        if(found==0)
        {
            ...
            if(ch=='n'||ch=='N')
            {
                cout<<"SPRITAN => What shall i do next?\n";
            }                
            if(ch=='y'||ch=='Y')
              {
               strcpy(stud1.que,Q);
               cout<<"SPRITAN => Please tell me the answer   :\n";
               cout<<"You     => ";
               cin.getline(stud1.answ,80);
               fio.write((char *)&stud1, sizeof(stud1));
               cout<<"SPRITAN => Thanks for teaching me....\n";
             }
        }
        fio.close();
    }
